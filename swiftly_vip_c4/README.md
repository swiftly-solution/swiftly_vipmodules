<p align="center">
  ...
  <h3 align="center">[VIP] C4</h3>

  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/swiftly_vipcore">Swiftly VIP Core</a> that gives C4 to VIP Players at spawn.
    <br/>
  </p>
</p>
...
2. Add `givec4` to the desired VIP Group in `addons/swiftly/configs/plugins/vips.json`.
### Example:
```json
	"groups": [
		{
