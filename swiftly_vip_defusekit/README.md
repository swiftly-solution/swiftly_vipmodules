<p align="center">
  ...
  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/swiftly_vipcore">Swfitly VIP Core</a> that gives Defuse Kit to VIP Players.
    <br/>
  </p>
</p>
...
2. Add `defusekit` in the desired VIP Group in `addons/swiftly/configs/plugins/vips.json`.
### Example:
```json
	"groups": [
		{
			...
			"features": {
				"defusekit": 1, // (put , if you need to)
			}
		}
	],
```
