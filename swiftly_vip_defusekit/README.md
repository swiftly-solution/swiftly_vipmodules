<p align="center">
  ...
  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/swiftly_vipcore">Swiftly VIP Core</a> that gives Defuse Kit to VIP Players.
    <br/>
  </p>
</p>
	...
	"groups": [
		{
			...
			"features": {
				"defusekit": 0/1 // (put , if you need to)
			}
		}
	],
```
