<p align="center">
  ...
  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/swiftly_vipcore">Swiftly VIP Core</a> that gives an amount of HP to a VIP Player when he makes a kill.
    <br/>
  </p>
</p>
	...
	"groups": [
		{
			...
			"features": {
				"regenhp": value, // (put , if you need to)
			}
		}
	],
```
