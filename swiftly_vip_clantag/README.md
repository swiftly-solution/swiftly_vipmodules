<p align="center">
  ...
  <h3 align="center">[VIP] Clan Tag</h3>

  <p align="center">
    A module for <a href="https://github.com/swiftly-solution/swiftly_vipcore">Swiftly VIP Core</a> that adds a prefix in scoreboard to VIP Players.
    <br/>
  </p>
</p>
...
2. Add `clantag` to the desired VIP Group in `addons/swiftly/configs/plugins/vips.json`.
### Example:
```json
	"groups": [
		{
			...
			"features": {
				"clantag": "[VIP Group]" // The prefix that your VIP Players will have in the scoreboard (put , if you need to).
			}
		}
	],
```
